            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 px-10 py-8">
                ...
                <div>
                    ...
                    <ul className="space-y-4">
                        <li><a href="javascript:void(0)" className="text-gray-400 hover:text-white text-base">Solar Installations</a></li>
                        <li><a href="javascript:void(0)" className="text-gray-400 hover:text-white text-base">Solar Energy Maintenance</a>
                        </li>
                        <li><a href="javascript:void(0)" className="text-gray-400 hover:text-white text-base">Solar Engineering Design</a></li>
                        <li><a href="javascript:void(0)" className="text-gray-400 hover:text-white text-base">Solar Consulting</a></li>
                    </ul>
                </div>

                <div className="space-y-4">
                    <h4 className="text-lg font-semibold mb-6 text-white">Contact Us</h4>
                    <p className="text-gray-400 text-base">abed.alroufe@gmail.com</p>
                    <p className="text-gray-400 text-base">+961 7637769</p>
                </div>
